...
const RecipeCard = ({recipeCard}) => {
   ...
   const handleFavorite = event =>{
      ...
      toast("Wow! This food is amazing");
   }
   return (
...
<p className='text-pink-800  text-xl'> <span className='font-semibold text-purple-600'>Rating :</span> {rating}</p>
    ...
    <button onClick={handleFavorite} className='btn bottom-0 bg-gradient-to-br from-pink-600  to-purple-600 border-0 ps-8 pe-8'>Favorite</button>
